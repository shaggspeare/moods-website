      ...
      <div className="container">
        <div className="row align-items-center mil-mb-90">
          <div className="col-md-6 col-xl-6">
            <span className="mil-suptitle mil-suptitle-2 mil-mb-30">{SectionData.subtitle}</span>
            <h2>{SectionData.title}</h2>
          </div>
          <div className="col-md-6 col-xl-6">
            <div className="mil-adaptive-right mil-mt-60-adapt">
              <div className="mil-slider-nav">
                <div ref={prevRef} className="mil-slider-btn-prev mil-blog-prev">
                  <i className="fas fa-arrow-left" />
                  <span className="mil-h6">Prev</span>
                </div>
                <div ref={nextRef} className="mil-slider-btn-next mil-blog-next">
        ...
        >
          {latestPosts.map((item, key) => (
            <SwiperSlide className={`swiper-slide ${item.classOne}`} key={key}>
